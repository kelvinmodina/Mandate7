<?php get_header(); ?>
			...
			<div id="company-desc">
				...
				<div class="vc_col-sm-8 wpb_column vc_column_container">
					  ...
					  <p>Mandate Seven Advisory is a boutique consulting firm that caters to institutional investors in the Gulf region.
					 Mandate Seven Advisory is  a joint venture between its founder <br>and the Kuwait Small Projects Company, founded in 2014.</p>
					  </div>
				</div>
			</div>
			...
			<div class="service-quoute">
				<div class="container"><p>We are run by <strong>seasoned</strong> individuals with <strong>local</strong> and <strong>international</strong> experience. </p></div>
			</div>
			<!-- Services Section -->
			<div id="services">
				<div class="container">
