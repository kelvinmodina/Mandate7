...
class Tweets_Widget extends WP_Widget {
      ...
      if ( $title ) {
        ...
        //Display the name 
		   ...
		   ?>
			...
			<div id="twitter-box" class="clearfix">
				<div id="tweet-slider" class="owl-carousel">
					...
					<div class="item">
						<span class="tweet_text">
							...
							<?php echo processString($tweet->text); ?>

						</span> - <small><?php echo $this->getAgo(strtotime($tweet->created_at)); ?></small>
					</div>
					<?php } ?>
				</div>
			</div>
    ...
    function form( $instance ) {
        ...
        $defaults = array( 'title' => __('Latest tweets.', 'mint'), 'name' => __('quanntvn', 'mint'),'custommerkey' => __('XcKyCQdCHCVFV8Ila3lcVg', 'mint'),'custommersecret' => __('DI6adVbO7ZQ9WuX7rCCumOQvMZTcxEWkBkWGTygI', 'mint'),'accesstoken' => __('1361529829-0veAbfrZ0zIHPrUnnHI7Xj6Jk8Fm7qgLrJZdAY6', 'mint'),'accesstokensecret' => __('ODVbWtpKbJOWhvy2OjuPM6bgeBOwwYIA1lgY2C9Dw', 'mint'),'num' => __(1, 'mint'));
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'custommerkey' ); ?>"><?php _e('Consumer key:', 'mint'); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'custommersecret' ); ?>"><?php _e('Consumer secret:', 'mint'); ?></label>
